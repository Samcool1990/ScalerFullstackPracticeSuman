console.log('1: ',this);  //"this" is an Window object
...
console.log('3: ', obj.getThis());   //Example bf : gf > crush > wife

const getThisFn = obj.getThis;

console.log('4: ', getThisFn());
...
console.log('7: ', getThisFn());  //

obj4.getThisFn = getThisFn;

console.log('8: ', obj4.getThisFn());

obj5.getThisFn = getThisFn;

console.log('9: ', obj5.getThisFn());
...
const getThisFnAfterMarriage = obj4.getThisFn.bind(obj5);  //binding is like marriage. obj5 will be binded to function
